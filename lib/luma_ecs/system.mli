...
(** [without_resource] represents a system that does not require access to any resources. *)
...
(** [with_resource] represents a system that runs with the resources returned by the
    [resource_query]. *)
