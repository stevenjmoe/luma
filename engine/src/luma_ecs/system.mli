type ('w, 'a) without_resources = {
  ...
  run : 'w -> Command.t -> (Luma__id.Id.Entity.t * 'a) list -> 'w;
}
...
type ('w, 'a, 'b) with_resources = {
  ...
  run : 'w -> Command.t -> (Luma__id.Id.Entity.t * 'a) list -> 'b -> 'w;
}
...
val make :
  ...
  string ->
  ('w -> Command.t -> (Luma__id.Id.Entity.t * 'a) list -> 'w) ->
  ('w, 'a) t
...
val make_with_resources :
  ...
  string ->
  ('w -> Command.t -> (Luma__id.Id.Entity.t * 'a) list -> 'b -> 'w) ->
  ('w, 'a) t
